...
목표였던 gain 51을 만족했습니다. 중간 노드에서 1단 gain이 약 3.2배로 나와, 의도한 −3 / −17 분배와 일치합니다.

## 단계별 출력 시뮬레이션

![단계별 출력 시뮬레이션](figures/r02-p05-1.png)

별도 실행에서는 1단 gain 3.172, 2단 16.24, 전체 51.53을 기록했습니다. 위의 51.0은 다른 캡처에서 계산한 값이라 같은 실행의 동일 값으로 합치지 않습니다. 모든 파형은 시뮬레이터 결과입니다.
