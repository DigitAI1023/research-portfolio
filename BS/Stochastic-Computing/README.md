...
4×4 구조는 2×4보다 면적과 전력이 증가하지만 MSE 감소로 종합 PAE FoM이 개선됩니다. 따라서 1.37배는 개별 전력·면적의 감소 배율이 아닌 **전력 × 면적 × 오차의 종합 지표** 비교입니다. Power·area는 Design Compiler 분석값이며 실칩 측정과 구분합니다.
