...
고정소수점 모델링, power-loader 정밀도 검토 및 TX/RX RTL 검증을 설명합니다. 초기 설계의 시뮬레이션 결과와 이후 원고의 실칩 측정을 구분해 개발 과정으로 연결합니다.

128 Gb/s는 최종 과제 목표이며 본 포트폴리오의 실측 달성값으로 사용하지 않습니다.
