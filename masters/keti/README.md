...
128-tap FFT/IFFT 구조, 고정소수점 스케일링 및 가변 CP를 설명하는 논문 figure입니다.

## Layout과 die photo

![Layout and die](figures/layout-die.png)

논문 Fig. 7. TX/RX DSP와 데이터 변환기 위치 및 DSP 면적 구성을 함께 제시합니다.
...
1차년도 보고서 16–18·23페이지는 고정소수점 모델링, power-loader 정밀도 검토 및 TX/RX RTL 검증을 설명합니다. 초기 설계의 시뮬레이션 결과와 이후 논문의 실칩 측정을 구분해 개발 과정으로 연결합니다.
...
측정 발표자료 2페이지에서 추출한 실험실 전경과 보드 사진입니다. 논문 결과와의 세부 배선·측정 시점 일치 여부는 검토 중입니다.
...
최종 논문은 loopback 기준 551 mW, 10.8 pJ/b를 보고합니다.
